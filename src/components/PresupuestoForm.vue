...
export default class PresupuestoForm extends Vue {
  ...
  guardarPresupuesto() {
    ...
    if (typeof this.presupuesto.divisa === "string") {
      codigoDivisa = JSON.parse(JSON.stringify(this.presupuesto.divisa));
    } else if (typeof this.presupuesto.divisa.value !== "undefined") {
      codigoDivisa = JSON.parse(JSON.stringify(this.presupuesto.divisa.value));
    }

    console.log(codigoDivisa);
    let presupuestoGuardar = JSON.parse(JSON.stringify(this.presupuesto));
    presupuestoGuardar["divisa"] = codigoDivisa;
